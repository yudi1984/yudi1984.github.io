...
<head>
    ...
    <style>
        ...
        .iframe-overlay {
            ...
            background: white; /* Matches the form background colo  r */
            z-index: 10;
        }
        ...
        .main-content {
            margin-left: 17%; /* Adjust this value to match the sidebar width */
            padding: 20px;
        }
    </style>
    <script>
...
<body class="h-screen flex">
    <!-- Sidebar -->
    <div class="sidebar w-1/6 bg-gradient-to-b from-[#48ECE5] to-[#FFFFFF]  p-6">
    <div class="flex items-center mb-8">
            <i class="fas fa-user-circle text-4xl"></i>
            <a href="welcome_petugas.php" class="ml-2 text-xl font-bold text-gray-800 hover:text-[#00C7BE]">My Dashboard</a>
        </div>
        <div class="space-y-6">
    ...
    Logout
        ...
        <div class="p-6 iframe-container">
            ...
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdDFn6Owf5-YJukwYGJE8L0VXa2al2Sfi407coGZhUvPBu92A/viewform?embedded=true" width="1280" height="3500" frameborder="0" marginheight="0" marginwidth="0" scrolling="no">Loading…</iframe>
